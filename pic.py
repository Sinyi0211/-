...
# 開啟資料表5
df = pd.read_excel('/Users/apple/Desktop/2020totalSale.xlsx',sheet_name='season3')
x=df['month']
...
# 開啟資料表6
df = pd.read_excel('/Users/apple/Desktop/2020totalSale.xlsx',sheet_name='season')
x6 = df['月份']
y5 = df['客單價']
y6 = df['平均值']
plt.bar(x6, y5, label='客單價',linewidth=5,)
